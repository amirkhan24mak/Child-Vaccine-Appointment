    ...
    <div class="container-scroller">
        ...
        <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
            <div class="navbar-brand-wrapper d-flex justify-content-center">
                <div class="navbar-brand-inner-wrapper d-flex justify-content-between align-items-center w-100">
                    <a class="navbar-brand brand-logo" href="{{url('/Hospitaldashobard/hostpital')}}"><img src="{{ url('/dstyle/images/logo.svg') }}"
                            alt="logo" /></a>
            ...
            <div class="navbar-menu-wrapper d-flex align-items-center justify-content-end">
                <ul class="navbar-nav mr-lg-2">
                    <li class="nav-item nav-profile dropdown">
                        <a class="nav-link" href="{{url('/Hospitaldashobard/hostpital')}}" data-toggle="dropdown" id="profileDropdown">
                            
                            <span class="nav-profile-name">{{session()->get('hospitalemail')}}</span>
                        </a>
        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <nav class="sidebar sidebar-offcanvas" id="sidebar">
                <ul class="nav">
                    <li class="nav-item">
                        <a class="nav-link" href="{{url('/Hospitaldashobard/hostpital')}}">
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="icons">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item"> <a class="nav-link" href="{{url('/Hospitaldashobard/hostpital/list')}}">Appointments
                                        List</a>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div class="collapse" id="form-elements">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item"><a class="nav-link"
                                        href="{{url('/Hospitaldashobard/hostpital/Profile_Update')}}">Update Profile</a> </li>
                            </ul>
                        </div>
                    </li>
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="ui-basi">
                            <ul class="nav flex-column sub-menu">
                                ...
                                <li class="nav-item"> <a class="nav-link"
                                        href="{{url('/logouthospital')}}">logout</a>
                                </li>
                            </ul>
                        </div>
                    </li>
