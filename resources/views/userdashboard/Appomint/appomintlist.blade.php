                                        ...
                                        <tbody>
                                            @foreach ($app as $appointments)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{url('/slipdetail')}}/{{$appointments->Id}} "class="btn btn-success m-2">Slip</a>

                                                        <a href="{{url('/appointment/delete')}}/{{$appointments->Id}}"class="btn btn-outline-danger m-2">Cencel</a>
                                                    </td>
                                                </tr>
                                            @endforeach
